...
public class MainActivity extends ActionBarActivity {
    ...
    public void submitOrder(View view) {
        ...
        CheckBox whippedCream2 = (CheckBox) findViewById(R.id.whipped_cream2_check_box);
        boolean haswhippedCream2 = whippedCream2.isChecked();

        CheckBox chocolateChips = (CheckBox) findViewById(R.id.chocolate_chips_check_box);
        boolean hasChocolateChips = chocolateChips.isChecked();
